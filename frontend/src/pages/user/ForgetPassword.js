    ...
    return (
        <div className="login-container">
            ...
            <div className="column2F">
                <h3 className='forget-password-F'><b>Reset Password</b></h3>
                <Form className='formF'>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicPassword">
                        ...
                        <Form.Control type="password" placeholder="Enter New Password" style={{ borderRadius: '50px', width: '120%', fontSize: '14px' }} />
                    </Form.Group>
